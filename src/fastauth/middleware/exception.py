...
class ExceptionHandlerMiddleware(BaseHTTPMiddleware):
    ...
    async def _handle_database_error(self, request_id: str, exc: SQLAlchemyError) -> JSONResponse:
    ...
    async def _handle_general_exception(self, request_id: str, exc: Exception) -> JSONResponse:
        """Handle general exceptions."""
        error_response = {
